// From https://raw.githubusercontent.com/expo/expo/main/packages/expo-speech/ios/EXSpeech/EXSpeech.m
...
@interface SpeechUtteranceWithId : AVSpeechUtterance
...
@implementation SpeechUtteranceWithId
  ...
  willSpeakRangeOfSpeechString:(NSRange)characterRange utterance:(nonnull AVSpeechUtterance *)utterance
{
  ...
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingWillSayNextString" body:@{ @"id": ((SpeechUtteranceWithId *) utterance).utteranceId, @"characterLocation": @(characterRange.location), @"characterLength": @(characterRange.length) }];
  }
}
  ...
  didStartSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStarted" body:@{ @"id": ((SpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didCancelSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingStopped" body:@{ @"id": ((SpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
 ...
 didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
  id<EXEventEmitterService> emitter = [_moduleRegistry getModuleImplementingProtocol:@protocol(EXEventEmitterService)];
  if (emitter != nil) {
    [emitter sendEventWithName:@"Exponent.speakingDone" body:@{ @"id": ((SpeechUtteranceWithId *) utterance).utteranceId }];
  }
}
...
EX_EXPORT_METHOD_AS(speak,
  ...
  AVSpeechUtterance *utterance = [[SpeechUtteranceWithId alloc] initWithString:text utteranceId:utteranceId];
